...
import typing
from minestudio.simulator.minerl.herobraine.hero.spaces import Dict
...
class EnvSpec(abc.ABC):
    U_MULTI_AGENT_ENTRYPOINT = 'minestudio.simulator.minerl.env._multiagent:_MultiAgentEnv'
    U_FAKE_MULTI_AGENT_ENTRYPOINT = 'minestudio.simulator.minerl.env._fake:_FakeMultiAgentEnv'
    U_SINGLE_AGENT_ENTRYPOINT = 'minestudio.simulator.minerl.env._singleagent:_SingleAgentEnv'
    U_FAKE_SINGLE_AGENT_ENTRYPOINT = 'minestudio.simulator.minerl.env._fake:_FakeSingleAgentEnv'
